...
const searchStopsRouter = express.Router();
module.exports = searchStopsRouter;
const axios = require("axios");

searchStopsRouter.post("/:filter/:longitude/:latitude", (req, res) => {
  const { filter, longitude, latitude } = req.params;
